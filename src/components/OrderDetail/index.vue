    ...
    <el-drawer :visible.sync="dialogVisible" :direction="direction" size="1000px" :before-close="handleClose">
          ...
          <div class="full">
            ...
            <div class="text">
              <div class="acea-row">
                ...
                <div class="ml5"> 一 </div>
                <div class="title ml5">
                  <div v-if="orderDatalist.secondType === 5 || orderDatalist.secondType === 6" class="value">自动发货</div>
      ...
      <div v-if="orderDatalist" v-loading="loading">
        <el-tabs type="border-card" v-model="activeName">
          ...
          <el-tab-pane v-if="orderDatalist.secondType === OrderSecondTypeEnum.Reservation" label="预约信息" name="reservation">
            <div class="detailSection" style="border: none">
  ...
  methods: {
    ...
    getDetail(id) {
      ...
      if (isPlatform) {
        ...
        areaApi.areasOrderInfoApi({ orderNo: id })
          .then((res) => {
            this.orderDatalist = res;
            this.orderExtend = res.orderExtend ? JSON.parse(res.orderExtend) : [];
            this.reservationInfo = res.orderDetailList[0] // 预约信息
