    ...
    <el-dialog title="启动流程" :visible.sync="startOpen" width="500px" append-to-body>
      <el-form ref="startForm" :model="startForm" :rules="startRules" label-width="100px">
        ...
        <el-form-item label="请假天数" prop="days">
             <el-select v-model="startForm.days" radio placeholder="请选择请假天数">
...
import { boundary, boundaryTrigger } from "@/api/ryFlowAble/activiti/message"
  ...
  methods: {
    ...
    handleTrigger(row){
        ...
        boundaryTrigger(params).then(res=>{
             this.$modal.msgSuccess("用户撤回，终止流程");
             this.resetQuery();
