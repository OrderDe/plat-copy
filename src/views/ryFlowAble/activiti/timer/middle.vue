    ...
    <el-dialog title="启动流程" :visible.sync="startOpen" width="500px" append-to-body>
      <el-form ref="startForm" :model="startForm" :rules="startRules" label-width="100px">
        ...
        <el-form-item label="商品名称" prop="goodsName">
             <el-select v-model="startForm.goodsName" radio placeholder="请选择商品名称">
...
<script>
import { middle, pageQuery } from "@/api/ryFlowAble/activiti/timer"
      ...
      this.$refs["startForm"].validate(valid => {
        if (valid) {
          ...
          const variables = {
            ...
            goodsName: this.startForm.goodsName
          }
          ...
          middle(variables).then(response => {
