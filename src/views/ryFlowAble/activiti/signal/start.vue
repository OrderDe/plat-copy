  ...
  <div class="app-container">
    ...
    <el-dialog title="启动流程" :visible.sync="startOpen" width="500px" append-to-body>
      <el-form ref="startForm" :model="startForm" :rules="startRules" label-width="100px">
        ...
        <el-form-item label="促销信号" >
          <el-input v-model="startForm.signalName" />
         </el-form-item>
      </el-form>
...
import { start } from "@/api/ryFlowAble/activiti/signal"
...
export default {
  ...
  data() {
    return {
      ...
      startRules: {
        signalName: [
          { required: true, message: "信号不能为空", trigger: "blur" }
        ]
      }
    }
  },
      ...
      this.$refs["startForm"].validate(valid => {
        if (valid) {
          ...
          const variables = {
            ...
            signalName: this.startForm.signalName,
          }
