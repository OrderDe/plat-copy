...
<script>
import { listTable, previewTable, delTable, genCode, synchDb } from "@/api/ryFlowAble/tool/gen"
...
export default {
  ...
  methods: {
    ...
    handleEditTable(row) {
      ...
      this.$tab.openPage("修改[" + tableName + "]生成配置", '/ryFlowAble/tool/gen-edit/index/' + tableId, params)
    },
    /** 删除按钮操作 */
    handleDelete(row) {
